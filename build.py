...
sys.path.append("/home/ubuntu22/Desktop/MyProjects/OSLabs/trampoline/make")
...
with_com = False
scheduler = "osek"
trampoline_base_path = "/home/ubuntu22/Desktop/MyProjects/OSLabs/trampoline/"
cflags = []
cppflags = []
ldflags = []
asflags = []
...
includeDirs += ["-I","/home/ubuntu22/Desktop/MyProjects/OSLabs/trampoline/machines/avr/arduino/cores/arduino"]
includeDirs += ["-I","/home/ubuntu22/Desktop/MyProjects/OSLabs/trampoline/machines/avr/arduino/"]
includeDirs += ["-I","/home/ubuntu22/Desktop/MyProjects/OSLabs/trampoline/machines/avr/arduino/variants/standard"]
includeDirs += ["-I","/home/ubuntu22/Desktop/MyProjects/OSLabs/trampoline/machines/avr"]
includeDirs += ["-I","/home/ubuntu22/Desktop/MyProjects/OSLabs/trampoline/machines/avr/arduino/cores/arduino"]
if with_ioc:
  includeDirs += ["-I", "/home/ubuntu22/Desktop/MyProjects/OSLabs/trampoline/ioc"]
includeDirs += ["-I", "/home/ubuntu22/Desktop/MyProjects/OSLabs/trampoline/com"]
includeDirs += ["-I", "/home/ubuntu22/Desktop/MyProjects/OSLabs/trampoline/os"]
includeDirs += ["-I", "/home/ubuntu22/Desktop/MyProjects/OSLabs/trampoline/debug"]
includeDirs += ["-I", "lab04_ex01"]
cflags   += includeDirs
...
#--- OIL file
oilSourceList.append("lab04_ex01.oil")
...
cSourceList.append(projfile.ProjectFile("lab04_ex01.cpp"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("lab04_ex01/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("lab04_ex01/tpl_dispatch_table.c"))
cSourceList.append(projfile.ProjectFile("lab04_ex01/tpl_invoque.S"))
cSourceList.append(projfile.ProjectFile("lab04_ex01/tpl_interrupts.c"))
...
if True:
  postCommand = makefile.PostCommand("Generating binary LAB04_Syn.hex from LAB04_Syn")
  postCommand.mCommand.append(r"avr-objcopy")
  postCommand.mCommand += "-O ihex".split()
  postCommand.mCommand.append("LAB04_Syn")
  postCommand.mCommand.append("LAB04_Syn.hex")
...
postVariableMapping = dict(
  MACHINE_PATH='/home/ubuntu22/Desktop/MyProjects/OSLabs/trampoline/machines',
  ARCH_PATH='/home/ubuntu22/Desktop/MyProjects/OSLabs/trampoline/machines/avr',
  BOARD_PATH='/home/ubuntu22/Desktop/MyProjects/OSLabs/trampoline/machines/avr/arduino/uno',
...
if make.errorCount() == 0:
  if askedGoal == "flash" :
    ...
    if makefile.find_executable("avrdude") != None:
      print("\033[1m\033[95mFlashing LAB04_Syn on avr/arduino/uno\033[0m")
