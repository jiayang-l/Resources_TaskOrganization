...
try:
	...
	print("\033[91mThe OS->BUILD->TRAMPOLINE_BASE_PATH key is not set correctly in the oil file lab04_ex01.oil.")
	print("Set the correct Trampoline installation path in the oil file and run goil again:\033[0m")
	print("goil -t=avr/arduino/uno --templates=/home/ubuntu22/Desktop/MyProjects/OSLabs/trampoline/goil/templates/ lab04_ex01.oil")
	sys.exit(1)
...
#----------------------------------------------------------------------
oilFile = "lab04_ex01.oil"
oilFileDep = "build/" + oilFile + ".dep"
oilCompiler = "goil"
oilFlags = ["-t=avr/arduino/uno", "--templates=/home/ubuntu22/Desktop/MyProjects/OSLabs/trampoline/goil/templates/"]
...
#--- Add generated files
sourceList.append("lab04_ex01/tpl_app_config.c")

sourceList.append("lab04_ex01/tpl_dispatch_table.c")
sourceList.append("lab04_ex01/tpl_invoque.S")
sourceList.append("lab04_ex01/tpl_interrupts.c")
